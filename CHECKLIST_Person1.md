...
| 13 | 3.5 | B3.5 Evaluation + 4 serving artifacts → metrics.csv | **Colab** | Critical | **Done** | 100 | `notebooks/Runned/03_als_eval_artifacts.ipynb` + `evidence/b3_4_als_eval.txt` | metrics.csv (RMSE + Recall/NDCG@10/20 ALS vs Popularity); model saved als_v1.0.0 + seed parquet 32M + model_card.json |
